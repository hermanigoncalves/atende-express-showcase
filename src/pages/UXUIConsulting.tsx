    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl">
            <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight">
              O que uma <span className="bg-gradient-to-r from-vibrant-blue to-energetic-orange bg-clip-text text-transparent">Consultoria de UX/UI</span> faz?
            </h1>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-navy-blue mb-4">Frentes de Trabalho</h2>
      ...
      <div className="bg-gray-50 py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-navy-blue mb-4">Como a Consultoria Pode Alavancar suas Vendas?</h2>
            <p className="text-xl text-navy-blue/80 max-w-3xl mx-auto">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="bg-gradient-to-r from-primary/10 via-secondary/10 to-accent/10 rounded-2xl p-12 border border-primary/20 text-center">
          <h2 className="text-4xl font-bold text-navy-blue mb-6">Resumo</h2>
          <p className="text-xl text-navy-blue/80 max-w-4xl mx-auto leading-relaxed mb-8">
